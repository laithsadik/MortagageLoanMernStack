...
export default function ContactFormAboveOneHandreds() {
        ...
        <div className="flex flex-col lg:flex-row lg:justify-around gap-2">
          <div className="max-w-sm lg:max-w-5xl w-full mt-8 lg:mt-16 flex flex-col gap-3 lg:gap-6">
            <div className="w-full" dir="rtl">
              <h1 className="text-xl lg:text-3xl mr-2 lg:mr-0 font-semibold text-right text-green-600 ">
                נא ליצור קשר
              </h1>
              <hr className="max-w-lg lg:max-w-4xl w-full h-1 lg:h-2 mt-3 bg-slate-400" />
            </div>
            <h1 className="text-lg lg:text-3xl  font-semibold text-right text-slate-700 ">
              טופס יצירת קשר
            </h1>
                ...
                <div className="flex flex-col gap-10">
                  ...
                  <div className="flex flex-col gap-4 mr-8 lg:mr-0">
                    ...
                    <button
                      disabled={loading}
                      type="submit"
                      className=" disabled:opacity-60 border h-12 mb-2 text-white text-lg mx-auto lg:mx-0 w-20 lg:w-36 bg-slate-600 rounded-lg font-semibold hover:opacity-90"
                    >
                      {loading ? "טוען..." : "שלח"}
                    </button>
                  </div>
          ...
          >
            ...
            <Link
              ...
              className="no-underline hover:underline"
            >
              <p className="text-slate-500 mr-3  font-bold  text-base mt-4">
                מעוניין לקחת הלוואה מעל 100 אלף שייח
              </p>
            </Link>
            <Link to={"/contactform"} className="no-underline hover:underline">
              <h4 className="text-slate-500text-lg">צור קשר</h4>
            </Link>
          </div>
        </div>
      </main>
